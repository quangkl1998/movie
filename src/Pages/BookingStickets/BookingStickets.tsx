...
import { bookTicket, changeTab, getBookingSticket, getInfoBooked, getSticketAction } from "Slices/bookingSlice";
...
const BookingStickets = () => {
    ...
    const { bookingSticket, listSeatBooked, isLoading, tabActive } = useSelector((state: RootState) => state.booking);
    ...
    const renderSeats = () => {
        return bookingSticket?.danhSachGhe.map((seat, index) => {
            ...
            let classSeatVIPBooked = seat.loaiGhe === "Vip" && seat.daDat ? "seatVIPBooked" : "";
            let classSeatBooking = "";

            let indexSeatBooked = listSeatBooked.findIndex((seatBooked) => seat.maGhe === seatBooked.maGhe);
                    ...
                    <Tabs defaultActiveKey="1" activeKey={tabActive} onChange={onChange}>
                                ...
                                <div className="row" style={{ margin: "0", height: "100%" }}>
                                    ...
                                    <div className="col-3 buySticket hideOnMobile">
                                        ...
                                        <div className="filmInfo">
                                            ...
                                            <img className="imgFilm" src={bookingSticket?.thongTinPhim?.hinhAnh} />
                                        </div>
                                        <div className="seatBookings">
                                            <div className="title ">
                                                ...
                                                {_.sortBy(listSeatBooked).map((seat, index) => {
                                                    return (
                                                        <span className="seatNameBooking" key={`seatB-${index}`}>
                                                            {seat.stt},
                                                        </span>
                                                    );
                                                })}
                                        ...
                                        <div className="seatBookings">
                                            <div className="title ">
                                                ...
                                                {listSeatBooked.map((seat, index) => {
                                                    return (
                                                        <span className="seatNameBooking" key={`seatBd-${index}`}>
                                                            {seat.stt},
                                                        </span>
                                                    );
                                                })}
                        ...
                        >
                            ...
                            <div className="text-center px-3 py-5">
                                <NavLink to="/" className="btn btn-success" style={{ fontSize: "18px" }}>
                                    Về trang chủ
                                </NavLink>
                            </div>
                        </TabPane>
